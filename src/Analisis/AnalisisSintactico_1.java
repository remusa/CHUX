...
public class AnalisisSintactico_1 {
...
//        {"sentencias'"},   //37
    ...
    private void CargarTrans() {//Paso para obtener id "5"
        ...
        //llamadas a funciones
//        Transicion.put("sentencias,50", "35"); //35
//        Transicion.put("llamada,50", "36"); //36
//        Transicion.put("llamada',50", "37"); //37
//        Transicion.put("llamada',50", "38"); //38
    }
    ...
    public ArrayList<Token> analizarSintactica(ArrayList tokens, JTextArea ta, Vista vista) {
